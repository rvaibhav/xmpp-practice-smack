...
/**
 * Created by vaibhavr on 16/02/16.
 */
public final class GeoLocation extends Item {
    ...
    public String toXML() {
        ...
        xml.optElement("accuracy", (accuracy!=null)?accuracy.toString():null);
        xml.optElement("alt", (alt!=null)?alt.toString():null);
        xml.optElement("area", (area!=null)?area:null);
        xml.optElement("bearing", (bearing!=null)?bearing.toString():null);
        xml.optElement("building", (building!=null)?building:null);
        xml.optElement("country", (country!=null)?country:null);
        xml.optElement("countrycode", (countryCode!=null)?countryCode:null);
        xml.optElement("datum", (datum!=null)?datum:null);
        xml.optElement("description", (description!=null)?description:null);
        xml.optElement("error", (error!=null)?error.toString():null);
        xml.optElement("floor", (floor!=null)?floor:null);
        xml.optElement("lat", (lat!=null)?lat.toString():null);
        xml.optElement("locality", (locality!=null)?locality:null);
        xml.optElement("lon", (lon!=null)?lon.toString():null);
        xml.optElement("postalcode", (postalcode!=null)?postalcode:null);
        xml.optElement("region", (region!=null)?region:null);
        xml.optElement("room", (room!=null)?room:null);
        xml.optElement("speed", (speed!=null)?speed.toString():null);
        xml.optElement("street", (street!=null)?street:null);
        xml.optElement("text", (text!=null)?text:null);
        xml.optElement("timestamp", (timestamp!=null)?timestamp.toString():null);
        xml.optElement("tzo", (tzo!=null)?tzo:null);
        xml.optElement("uri", (uri!=null)?uri.toString():null);
